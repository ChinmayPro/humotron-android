...
import com.humotron.app.databinding.ItemContactAttachmentBinding
import java.io.File

class ContactAttachmentAdapter(
    private val onDeleteClick: (Uri) -> Unit
) : ListAdapter<Uri, ContactAttachmentAdapter.ViewHolder>(UriDiffCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemContactAttachmentBinding.inflate(
    ...
    inner class ViewHolder(private val binding: ItemContactAttachmentBinding) :
