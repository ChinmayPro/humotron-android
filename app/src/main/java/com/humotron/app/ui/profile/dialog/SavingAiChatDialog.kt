...
import com.humotron.app.databinding.DialogSavingAiChatBinding

class SavingAiChatDialog(
    context: Context,
    private val onCompleted: () -> Unit
) : Dialog(context) {

    private lateinit var binding: DialogSavingAiChatBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DialogSavingAiChatBinding.inflate(layoutInflater)
