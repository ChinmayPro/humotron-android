...
class YetToTrackGroupedAdapter(
    private var groupedMetrics: List<GroupedMetricData>,
    private val onItemClick: (GroupedMetricData) -> Unit,
) : RecyclerView.Adapter<YetToTrackGroupedAdapter.GroupedViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GroupedViewHolder {
        val binding = ItemTrackingGroupedMetricBinding.inflate(LayoutInflater.from(parent.context), parent, false)
