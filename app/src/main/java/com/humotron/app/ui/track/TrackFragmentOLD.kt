...
import com.humotron.app.databinding.FragmentTrackOldBinding
...
@AndroidEntryPoint
class TrackFragmentOLD : BaseFragment(R.layout.fragment_track_old), OnClickListener {

    private lateinit var binding: FragmentTrackOldBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = FragmentTrackOldBinding.bind(view)
