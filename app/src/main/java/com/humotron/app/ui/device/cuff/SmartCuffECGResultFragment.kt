...
import com.humotron.app.databinding.FragmentSmartCuffEcgResultBinding
...
@AndroidEntryPoint
class SmartCuffECGResultFragment :
    BaseFragment(R.layout.fragment_smart_cuff_ecg_result),
    View.OnClickListener {

    private lateinit var binding: FragmentSmartCuffEcgResultBinding
    private var userDevice: UserDevice? = null
    private var readingType: BPMachineReadingType? = null

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        binding = FragmentSmartCuffEcgResultBinding.bind(view)
    ...
    private fun initClicks() {
        binding.header.btnBack.setOnClickListener(this@SmartCuffECGResultFragment)
        binding.btnDone.setOnClickListener(this@SmartCuffECGResultFragment)
    }
