...
import com.humotron.app.databinding.DialogSavingGoalsBinding

class SavingGoalsDialog(
    context: Context,
    private val onCompleted: () -> Unit
) : Dialog(context) {

    private lateinit var binding: DialogSavingGoalsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DialogSavingGoalsBinding.inflate(layoutInflater)
