...
import com.humotron.app.databinding.DialogSavingInsightsBinding

class SavingInsightsDialog(
    context: Context,
    private val onCompleted: () -> Unit
) : Dialog(context) {

    private lateinit var binding: DialogSavingInsightsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DialogSavingInsightsBinding.inflate(layoutInflater)
